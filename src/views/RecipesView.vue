...
<template>
  <div class="recipe-discovery-page min-vh-100" style="background: linear-gradient(180deg, #e8f5e9 0%, #ffffff 100%);">
...
<style scoped>
/* Minimal page-specific styles - most moved to components */
</style>