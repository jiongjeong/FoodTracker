    ...
    <div class="container-fluid px-3 px-md-4">
      ...
      <div class="row align-items-center g-4 position-relative">
        ...
        <div class="col-lg-6 position-relative" style="z-index: 10;">
          ...
          <div class="input-group shadow-sm mb-2 search-bar bg-white">
            <input :value="searchQuery" @input="$emit('update:searchQuery', $event.target.value)" type="text"
              class="form-control border-0 px-4 py-3" placeholder="Search recipes (e.g., pasta, chicken, tomato)"
        ...
        <div class="col-lg-6 position-relative d-none d-lg-flex justify-content-center" style="z-index: 5;">
          <div
            class="food-plate rounded-circle shadow-lg overflow-hidden d-flex align-items-center justify-content-center bg-dark">
      ...
      <!-- Category Pills -->
      <div class="category-pills d-flex flex-wrap gap-2 overflow-auto pb-2 mt-4 position-relative"
        style="scrollbar-width: none; -ms-overflow-style: none; z-index: 20;">
        <button @click="$emit('update:activeTab', 'search')"
